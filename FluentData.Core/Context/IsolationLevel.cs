...
{
    /// <summary>
    /// Specifies the transaction isolation level, which controls the locking behavior and data visibility between concurrent transactions.
    /// </summary>
    public enum IsolationLevel
    {
        ...
        /// <summary>
        /// A range lock is placed on the data, preventing other users from updating or inserting rows into the dataset until the transaction is complete.
        /// </summary>
