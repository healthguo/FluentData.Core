...
namespace FluentData.Core
{
    ...
    public class DmProvider : IDbProvider
    {
        ...
        /// <summary>
        /// Registers the DM DbProviderFactory for dynamic provider loading.
        /// </summary>
        ...
        {
            DbProviderFactories.RegisterFactory(providerName ?? this.ProviderName, "Dm.DmClientFactory, DM.DmProvider");
        }

        /// <summary>
        /// Gets the registered DbProviderFactory for creating DM database connections and commands.
        /// </summary>
        /// <param name="providerName">Optional provider name. If null, uses the default provider name.</param>
        /// <returns>The <see cref="DbProviderFactory"/> instance for DM.</returns>
        ...
        /// <summary>
        /// Unregisters a previously registered DM DbProviderFactory.
        /// </summary>
