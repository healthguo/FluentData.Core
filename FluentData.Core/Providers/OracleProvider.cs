...
namespace FluentData.Core
{
    ...
    public class OracleProvider : IDbProvider
    {
        ...
        /// Oracle supports output parameters.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether Oracle supports multiple result sets in a single query.
        ...
        /// <summary>
        /// Gets a value indicating whether Oracle supports multiple queries in a single command.
        /// Oracle supports multiple queries.
        /// </summary>
        ...
        /// Oracle supports stored procedures.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether Oracle requires explicit identity column specification for INSERT operations.
        /// Oracle requires explicit identity column specification.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new database connection for Oracle using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string for connecting to the Oracle database.</param>
        /// <returns>A new <see cref="IDbConnection"/> instance for Oracle.</returns>
        ...
        /// <summary>
        /// Gets the alias format for SELECT builder column names using Oracle syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates a SELECT SQL statement with optional paging using Oracle syntax.
        /// Uses ROW_NUMBER() for paging.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an INSERT builder using Oracle syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an UPDATE builder using Oracle syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for a DELETE builder using Oracle syntax.
        /// </summary>
        ...
        /// <summary>
        /// Gets the SQL statement for a stored procedure builder using Oracle syntax.
        /// </summary>
        ...
        /// <summary>
        /// Maps a CLR type to the corresponding Oracle database data type.
        /// </summary>
        ...
        /// <summary>
        /// Called before a command is executed to configure Oracle-specific command settings.
        ...
        /// <summary>
        /// Registers the Oracle DbProviderFactory for dynamic provider loading.
        /// </summary>
        ...
        {
            DbProviderFactories.RegisterFactory(providerName ?? this.ProviderName, "Oracle.ManagedDataAccess.Client.OracleClientFactory, Oracle.ManagedDataAccess");
        }

        /// <summary>
        /// Gets the registered DbProviderFactory for creating Oracle database connections and commands.
        /// </summary>
        /// <param name="providerName">Optional provider name. If null, uses the default provider name.</param>
        /// <returns>The <see cref="DbProviderFactory"/> instance for Oracle.</returns>
        ...
        /// <summary>
        /// Unregisters a previously registered Oracle DbProviderFactory.
        /// </summary>
