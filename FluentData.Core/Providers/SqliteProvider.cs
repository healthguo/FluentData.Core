...
{
    /// <summary>
    /// Database provider for SQLite.
    /// Supports output parameters and multiple result sets.
    /// Does NOT support stored procedures.
    /// Uses last_insert_rowid() for retrieving last inserted identity values.
    /// Uses LIMIT/OFFSET for paging.
    /// </summary>
    public class SqliteProvider : IDbProvider
    {
        /// <summary>
        /// Gets the ADO.NET provider name for SQLite.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether SQLite supports output parameters.
        /// SQLite supports output parameters.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether SQLite supports multiple result sets in a single query.
        /// SQLite supports multiple result sets.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether SQLite supports multiple queries in a single command.
        /// SQLite supports multiple queries.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether SQLite supports stored procedures.
        ...
        /// <summary>
        /// Gets a value indicating whether SQLite requires explicit identity column specification for INSERT operations.
        /// SQLite does NOT require explicit identity column specification.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new database connection for SQLite using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string for connecting to the SQLite database.</param>
        /// <returns>A new <see cref="IDbConnection"/> instance for SQLite.</returns>
        ...
        /// <summary>
        /// Formats a parameter name with the SQLite prefix (@).
        /// </summary>
        ...
        /// <summary>
        /// Gets the alias format for SELECT builder column names using SQLite syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates a SELECT SQL statement with optional paging using SQLite syntax.
        /// Uses LIMIT/OFFSET for paging.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an INSERT builder using SQLite syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an UPDATE builder using SQLite syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for a DELETE builder using SQLite syntax.
        /// </summary>
        ...
        /// <summary>
        /// Throws <see cref="NotImplementedException"/> as SQLite does not support stored procedures.
        /// </summary>
        /// <param name="data">The builder data.</param>
        /// <returns>Never returns (throws exception).</returns>
        /// <exception cref="NotImplementedException">Always thrown as SQLite does not support stored procedures.</exception>
        ...
        /// <summary>
        /// Maps a CLR type to the corresponding SQLite database data type.
        /// </summary>
        ...
        /// <summary>
        /// Executes an INSERT command and returns the last inserted identity value using last_insert_rowid().
        /// </summary>
        /// <typeparam name="T">The type of the identity value.</typeparam>
        /// <param name="command">The database command to execute.</param>
        /// <param name="identityColumnName">Optional identity column name (not used for SQLite).</param>
        ...
        /// <summary>
        /// Called before a command is executed. No provider-specific configuration is needed for SQLite.
        /// </summary>
        ...
        /// <summary>
        /// Escapes a column name using SQLite square bracket syntax.
        /// </summary>
        ...
        /// <summary>
        /// Registers the SQLite DbProviderFactory for dynamic provider loading.
        /// </summary>
        ...
        {
            DbProviderFactories.RegisterFactory(providerName ?? this.ProviderName, "System.Data.SQLite.SQLiteFactory, System.Data.SQLite");
        }

        /// <summary>
        /// Gets the registered DbProviderFactory for creating SQLite database connections and commands.
        /// </summary>
        /// <param name="providerName">Optional provider name. If null, uses the default provider name.</param>
        /// <returns>The <see cref="DbProviderFactory"/> instance for SQLite.</returns>
        ...
        /// <summary>
        /// Unregisters a previously registered SQLite DbProviderFactory.
        /// </summary>
