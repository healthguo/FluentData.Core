...
namespace FluentData.Core
{
    ...
    public class PostgreSqlProvider : IDbProvider
    {
        ...
        /// PostgreSQL supports output parameters.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether PostgreSQL supports multiple result sets in a single query.
        /// PostgreSQL supports multiple result sets.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether PostgreSQL supports multiple queries in a single command.
        /// PostgreSQL supports multiple queries.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether PostgreSQL requires explicit identity column specification for INSERT operations.
        /// PostgreSQL does NOT require explicit identity column specification.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new database connection for PostgreSQL using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string for connecting to the PostgreSQL database.</param>
        ...
        /// <summary>
        /// Gets the alias format for SELECT builder column names using PostgreSQL syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates a SELECT SQL statement with optional paging using PostgreSQL syntax.
        /// Uses LIMIT/OFFSET for paging.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an INSERT builder using PostgreSQL syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for an UPDATE builder using PostgreSQL syntax.
        /// </summary>
        ...
        /// <summary>
        /// Generates the SQL statement for a DELETE builder using PostgreSQL syntax.
        /// </summary>
        ...
        /// <summary>
        /// Gets the SQL statement for a stored procedure builder using PostgreSQL syntax.
        /// </summary>
        ...
        /// <summary>
        /// Maps a CLR type to the corresponding PostgreSQL database data type.
        /// </summary>
        ...
        /// <summary>
        /// Called before a command is executed. No provider-specific configuration is needed for PostgreSQL.
        /// </summary>
        ...
        /// <summary>
        /// Registers the PostgreSQL DbProviderFactory for dynamic provider loading.
        /// </summary>
        ...
        {
            DbProviderFactories.RegisterFactory(providerName ?? this.ProviderName, "Npgsql.NpgsqlFactory, Npgsql");
        }

        /// <summary>
        /// Gets the registered DbProviderFactory for creating PostgreSQL database connections and commands.
        /// </summary>
        /// <param name="providerName">Optional provider name. If null, uses the default provider name.</param>
        /// <returns>The <see cref="DbProviderFactory"/> instance for PostgreSQL.</returns>
        ...
        /// <summary>
        /// Unregisters a previously registered PostgreSQL DbProviderFactory.
        /// </summary>
