...
namespace FluentData.Test.IntegrationTests.Features.Providers
{
	...
	public class AdoNetProviderTests
	{
		...
		public void Test2()
		{
			new DbContext().ConnectionStringNameFromConfigFile("ProviderTest", new SqlServerProvider());
		}

		
		public void Test3()
		{
			new DbContext().ConnectionStringNameFromConfigFile("ProviderTest2", new SqlServerProvider());
		}
	}
